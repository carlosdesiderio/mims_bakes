...
public class BakesRequestUtilsTest {
    ...
    private static final String BAKING_URL_STRING = "https://d17h27t6h515a5.cloudfront.net/topher/2017/May/59121517_baking/baking.json";
    ...
    public void buildBakingApiTest() {
         ...
         assertNotNull("Returns NULL Retrofit Request object", call.request());

         String actualUrlString = call.request().url().toString();

         Assert.assertEquals("Return WRONG url: " + actualUrlString, BAKING_URL_STRING, actualUrlString);
     }
}